...
libraryDependencies ++= Seq(
  "dev.zio"                %% "zio-streams"                 % "1.0.0-RC21-2+9-395bb5b6-SNAPSHOT",
  "dev.zio"                %% "zio-test"                    % "1.0.0-RC21-2+9-395bb5b6-SNAPSHOT" % "test",
  "dev.zio"                %% "zio-test-sbt"                % "1.0.0-RC21-2+9-395bb5b6-SNAPSHOT" % "test",
